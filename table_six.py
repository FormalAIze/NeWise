...
if __name__ == '__main__':
    ...
    run_certified_bounds(path_prefix + 'mnist_ffnn_3x200_with_positive_weights_9420.h5', 100, 105, 1, method='NeWise', mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'mnist_ffnn_3x200_with_positive_weights_9420.h5', 100, 105, 1, method='DeepCert', mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'mnist_ffnn_3x200_with_positive_weights_9420.h5', 100, 105, 1, method='VeriNet', mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'mnist_ffnn_3x200_with_positive_weights_9420.h5', 100, 105, 1, method='RobustVerifier', mnist=True, log_name=log_name)
    
    run_certified_bounds(path_prefix + 'mnist_ffnn_3x400_with_positive_weights_9630.h5', 100, 105, 1, method='NeWise', mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'mnist_ffnn_3x400_with_positive_weights_9630.h5', 100, 105, 1, method='DeepCert', mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'mnist_ffnn_3x400_with_positive_weights_9630.h5', 100, 105, 1, method='VeriNet', mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'mnist_ffnn_3x400_with_positive_weights_9630.h5', 100, 105, 1, method='RobustVerifier', mnist=True, log_name=log_name)
    ...
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_2x100_with_positive_weights_sigmoid.h5', 100, 105, 1, method='NeWise', fashion_mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_2x100_with_positive_weights_sigmoid.h5', 100, 105, 1, method='DeepCert', fashion_mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_2x100_with_positive_weights_sigmoid.h5', 100, 105, 1, method='VeriNet', fashion_mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_2x100_with_positive_weights_sigmoid.h5', 100, 105, 1, method='RobustVerifier', fashion_mnist=True, log_name=log_name)
    
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_3x200_with_positive_weights_sigmoid.h5', 100, 105, 1, method='NeWise', fashion_mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_3x200_with_positive_weights_sigmoid.h5', 100, 105, 1, method='DeepCert', fashion_mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_3x200_with_positive_weights_sigmoid.h5', 100, 105, 1, method='VeriNet', fashion_mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_3x200_with_positive_weights_sigmoid.h5', 100, 105, 1, method='RobustVerifier', fashion_mnist=True, log_name=log_name)
    
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_2x200_with_positive_weights_sigmoid.h5', 100, 105, 1, method='NeWise', fashion_mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_2x200_with_positive_weights_sigmoid.h5', 100, 105, 1, method='DeepCert', fashion_mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_2x200_with_positive_weights_sigmoid.h5', 100, 105, 1, method='VeriNet', fashion_mnist=True, log_name=log_name)
    run_certified_bounds(path_prefix + 'fashion_mnist_ffnn_2x200_with_positive_weights_sigmoid.h5', 100, 105, 1, method='RobustVerifier', fashion_mnist=True, log_name=log_name)
    ...
    printlog('generat the log of table 6 finished!!!', log_name)
